...
<img src="images/Screenshot (163).png" alt="n8n Trigger Node" width="600">  
*Screenshot showing the transcript.*

<img src="images/Screenshot (151).png" alt="n8n Trigger Node" width="600">  
...
<img src="images/Capture.JPG" alt="Gmail Summary" width="600"> 
...
3. Add the N8N Webhook Node credentials.

<img src="images/web.JPG"  width="600">

N8N webhook node settings will be in the section [Workflow Nodes](#workflow-nodes).
...
## Workflow Nodes
Here are the names of all the nodes in my workflow:

### 1. When Transcripting From Fireflies 
- Webhook node that receives data from fireflies.

<img src="images/Screenshot (155).png"  width="600">


### 2. Format The JSON Data
- Code node that formats the speech array into a readable transcript.

<img src="images/Screenshot (156).png"  width="600">


### 3. Model For Summarizing (GPT-4o) 
- HTTP Request node that calls OpenAI API to summarize.

<img src="images/Screenshot (157).png"  width="600">
<img src="images/Screenshot (141).png"  width="600"><img src="images/Screenshot (152).png"  width="600">
...
### 5. Loop Over Emails  
- Split in Batches node to process participants,
`Batch Size = 10`
...
<img src="images/Screenshot (162).png"  width="600">



### 8. Get All Participants Of The Meeting (ONLY FOR PAID ACCOUNTS)
- HTTP Request node for Zoom API (not connected in my flow)
- We need to get participants using the Meeting ID:

    - 1) Get the meeting UUID from the meeting ID
      ...
      {
        "id": 123456789,
        "uuid": "abcd%2Fefgh%2Fijkl",
        "topic": "My Meeting",
        ...
      }
      ```
     -  ### Note   : 
          If the UUID contains slashes, URL-encode them (replace / with %2F) using N8N node .

    - 2) Use the returned UUID to fetch participants for a past meeting
